...
export const messages: Record<string, string> = {
  ...
  'daemon.direct_model_list_header': 'Current model: {current}\nAvailable models ({cliName}):',
  'daemon.direct_model_list_none': 'Current model: {current}\n{cliName} does not declare any enumerable models; send /model <model> to switch this session.',
  'daemon.direct_model_list_hint': 'Send /model <model> to switch this session; if you are in an interactive TUI, the native model menu still exists.',
  'daemon.direct_effort_list_header': 'Current reasoning effort: {current}\nAvailable levels ({model}):',
  'daemon.direct_effort_list_hint': 'Send /effort <level> to switch this session; if the CLI has a native menu, it still works too.',
  'daemon.direct_effort_unsupported_cli': '⚠️ {cliName} does not support direct reasoning-effort switching.',
  'daemon.direct_effort_unsupported_model': '⚠️ The current model {model} does not support {effort}; available levels: {values}',
  'daemon.direct_effort_invalid': '⚠️ Reasoning effort must be one of {values}; you sent {effort}.',
  'daemon.direct_model_switched': '✅ Switched this session to model {model}; restarting {cliName} to apply it.',
  'daemon.direct_model_switched_cleared_effort': '✅ Switched this session to model {model} and cleared incompatible reasoning effort {effort}; restarting {cliName} to apply it.',
  'daemon.direct_effort_switched': '✅ Switched this session to reasoning effort {effort}; restarting {cliName} to apply it.',
  'daemon.direct_new_started': '✅ Cleared this session and restarted {cliName}; the next message will start a fresh turn.',
  'daemon.direct_adopt_unsupported': '⚠️ {cmd} does not support adopted sessions.',
  'daemon.direct_mutation_pending': '⚠️ {cmd} cannot run yet: this session still has unsettled messages.',
  ...
  'help.heading_direct': '🎛️ Direct-control commands (bypass model wrapping):',
  'help.model_list': '/model list  - List all available models',
  'help.model_set': '/model <model> - Switch this session to that model',
  'help.effort_list': '/effort list  - Show which reasoning-effort levels the current model supports',
  'help.effort_set': '/effort <level> - Switch this session to that reasoning-effort level',
  'help.new': '/new        - Start a fresh session',
  'daemon.cmd_retired': '{cmd} has been retired. Send /help to see the supported commands.',
