...
export const messages: Record<string, string> = {
  ...
  'daemon.direct_model_list_header': '当前模型：{current}\n可用模型（{cliName}）：',
  'daemon.direct_model_list_none': '当前模型：{current}\n{cliName} 没有声明可枚举模型；可直接发送 /model <模型名> 切换当前会话。',
  'daemon.direct_model_list_hint': '发送 /model <模型名> 切换当前会话；如果你现在用的是交互式 TUI，原生模型菜单仍会保留。',
  'daemon.direct_effort_list_header': '当前推理强度：{current}\n可用档位（{model}）：',
  'daemon.direct_effort_list_hint': '发送 /effort <档位> 切换当前会话；如果 CLI 本身支持原生菜单，它仍然可用。',
  'daemon.direct_effort_unsupported_cli': '⚠️ {cliName} 不支持直接切换推理强度。',
  'daemon.direct_effort_unsupported_model': '⚠️ 当前模型 {model} 不支持 {effort}；可选档位：{values}',
  'daemon.direct_effort_invalid': '⚠️ 推理强度只能是 {values}，你发的是 {effort}。',
  'daemon.direct_model_switched': '✅ 已将当前会话模型切到 {model}，正在重启 {cliName} 生效。',
  'daemon.direct_model_switched_cleared_effort': '✅ 已将当前会话模型切到 {model}，并清掉不再兼容的推理强度 {effort}，正在重启 {cliName} 生效。',
  'daemon.direct_effort_switched': '✅ 已将当前会话推理强度切到 {effort}，正在重启 {cliName} 生效。',
  'daemon.direct_new_started': '✅ 已清空当前会话并重启 {cliName}，下一条消息会作为新会话首轮发送。',
  'daemon.direct_adopt_unsupported': '⚠️ {cmd} 不支持接管中的会话。',
  'daemon.direct_mutation_pending': '⚠️ {cmd} 暂不能执行：当前会话还有未结算消息。',
  ...
  'help.heading_direct': '🎛️ 直控命令（不经模型包装）：',
  'help.model_list': '/model list  - 列出所有可选模型',
  'help.model_set': '/model <模型名> - 切换当前会话到对应模型',
  'help.effort_list': '/effort list  - 查看当前模型支持哪些推理强度',
  'help.effort_set': '/effort <强度> - 切换当前会话到对应推理强度',
  'help.new': '/new        - 新建一个 session',
  'daemon.cmd_retired': '{cmd} 已停用。发送 /help 查看当前支持的命令。',
