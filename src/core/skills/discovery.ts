...
/** Discover skills from the backend-independent botmux runtime root. */
export function discoverSharedSkills(): SkillPackage[] {
  return discoverSkillRoot(sharedSkillsDir());
}
